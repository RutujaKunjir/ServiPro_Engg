...
import com.example.servipro_engg.Adapter.ServiceReminderAdapter;
...
public class ServiceReminder extends AppCompatActivity
{
    ...
    private ServiceReminderAdapter taskAddAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_attended_detail);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                            ...
                            if (oneTime.isChecked()){
                                if (object2.getString("Amc_Id").equals("2")){
                                    mTaskList.add(new TaskList(
                                            ...
                                            ""+object2.getString("Amc_Call_No"),// pass amc call no
                    ...
                    taskAddAdapter = new ServiceReminderAdapter(ServiceReminder.this,mTaskList);
    ...
    {
        Intent intent = new Intent(ServiceReminder.this, Dashboard.class);
