...
import com.example.servipro_engg.Activity.MultipleService;
...
public class CustoListAdapter extends RecyclerView.Adapter<CustoListAdapter.TaskHolder> implements Filterable
{
    private Context mCtx;
    private List<TaskList> vendorLists;
    private List<TaskList> saleListsFull;

    public CustoListAdapter(Context mCtx, List<TaskList> vendorLists) {
        this.mCtx = mCtx;
    ...
    @NonNull
    @Override
    public CustoListAdapter.TaskHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.row_new_task2, null);
        return new CustoListAdapter.TaskHolder(view);    }

    @Override
    public void onBindViewHolder(@NonNull final CustoListAdapter.TaskHolder holder, final int position) {
        ...
        holder.dateTime_txt.setText(vendorList.getAmc_Details());
        holder.service_call_no_txt.setText(vendorList.getCust_id());
        ...
        holder.optionBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent updateIntent=  new Intent (mCtx, MultipleService.class);
